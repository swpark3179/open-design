...
export const ja: Dict = {
  ...
  'settings.customProviderHint': 'デーモンの設定ファイル（byok-providers.local.json）で定義します。',
  'settings.customProviderEmpty': 'カスタムプロバイダーが見つかりません。byok-providers.local.json で定義してください。',
  'settings.customProviderPlaceholder': 'プロバイダーを選択…',
