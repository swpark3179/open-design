...
export const en: Dict = {
  ...
  'settings.customProviderHint': 'Defined in your daemon config file (byok-providers.local.json).',
  'settings.customProviderEmpty': 'No custom providers found. Define one in byok-providers.local.json.',
  'settings.customProviderPlaceholder': 'Select a provider…',
