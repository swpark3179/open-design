...
export const en: Dict = {
  ...
  'settings.closedNetworkTitle': 'Closed network mode',
  'settings.closedNetworkOn': 'On',
  'settings.closedNetworkSourceEnv': 'Enabled by the OD_CLOSED_NETWORK environment variable',
  'settings.closedNetworkSourceFlagFile': 'Enabled by a flag file in your project location',
  'settings.closedNetworkFlagPath': 'Flag file: {path}',
  'settings.closedNetworkDescription': 'Links to GitHub and social networks, sharing to external sites, usage analytics, and automatic updates are turned off. Ask your administrator to change this.',
