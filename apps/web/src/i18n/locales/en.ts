...
export const en: Dict = {
  ...
  'settings.onboardingExecutionBodyClosedNetwork': 'Connect a local agent or use your own model key.',
  ...
  'settings.appNetwork': 'Network',
  'settings.appNetworkClosed': 'Closed network',
