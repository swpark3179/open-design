...
export const de: Dict = {
  ...
  'settings.customProviderHint': 'In Ihrer Daemon-Konfigurationsdatei (byok-providers.local.json) definiert.',
  'settings.customProviderEmpty': 'Keine benutzerdefinierten Anbieter gefunden. Definieren Sie einen in byok-providers.local.json.',
  'settings.customProviderPlaceholder': 'Anbieter auswählen…',
