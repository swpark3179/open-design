...
export const tr: Dict = {
  ...
  'settings.customProviderHint': 'Daemon yapılandırma dosyanızda (byok-providers.local.json) tanımlanır.',
  'settings.customProviderEmpty': 'Özel sağlayıcı bulunamadı. byok-providers.local.json içinde bir tane tanımlayın.',
  'settings.customProviderPlaceholder': 'Bir sağlayıcı seçin…',
