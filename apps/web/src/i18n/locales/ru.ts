...
export const ru: Dict = {
  ...
  'settings.customProviderHint': 'Определяется в файле конфигурации демона (byok-providers.local.json).',
  'settings.customProviderEmpty': 'Пользовательские провайдеры не найдены. Определите их в byok-providers.local.json.',
  'settings.customProviderPlaceholder': 'Выберите провайдера…',
