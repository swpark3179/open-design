...
export const it: Dict = {
  ...
  'settings.customProviderHint': 'Definito nel file di configurazione del daemon (byok-providers.local.json).',
  'settings.customProviderEmpty': 'Nessun provider personalizzato trovato. Definiscine uno in byok-providers.local.json.',
  'settings.customProviderPlaceholder': 'Seleziona un provider…',
