...
export const ar: Dict = {
  ...
  'settings.customProviderHint': 'مُعرَّف في ملف إعداد الخفي (byok-providers.local.json).',
  'settings.customProviderEmpty': 'لم يتم العثور على مزودين مخصصين. عرّف واحدًا في byok-providers.local.json.',
  'settings.customProviderPlaceholder': 'اختر مزودًا…',
