...
export const zhCN: Dict = {
  ...
  "settings.closedNetworkTitle": "闭网模式",
  "settings.closedNetworkOn": "已开启",
  "settings.closedNetworkSourceEnv": "由环境变量 OD_CLOSED_NETWORK 开启",
  "settings.closedNetworkSourceFlagFile": "由项目位置下的标记文件开启",
  "settings.closedNetworkFlagPath": "标记文件：{path}",
  "settings.closedNetworkDescription": "指向 GitHub 和社交网络的链接、分享到外部站点、使用分析和自动更新均已关闭。如需修改请联系管理员。",
