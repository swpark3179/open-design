...
export const zhCN: Dict = {
  ...
  'settings.customProviderHint': '在守护进程配置文件（byok-providers.local.json）中定义。',
  'settings.customProviderEmpty': '未找到自定义提供方。请在 byok-providers.local.json 中定义。',
  'settings.customProviderPlaceholder': '选择一个提供方…',
