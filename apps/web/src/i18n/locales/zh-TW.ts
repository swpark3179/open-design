...
export const zhTW: Dict = {
  ...
  'settings.customProviderHint': '在背景程式設定檔（byok-providers.local.json）中定義。',
  'settings.customProviderEmpty': '找不到自訂提供方。請在 byok-providers.local.json 中定義。',
  'settings.customProviderPlaceholder': '選擇一個提供方…',
