...
export const zhTW: Dict = {
  ...
  "settings.closedNetworkTitle": "封閉網路模式",
  "settings.closedNetworkOn": "已開啟",
  "settings.closedNetworkSourceEnv": "由環境變數 OD_CLOSED_NETWORK 開啟",
  "settings.closedNetworkSourceFlagFile": "由專案位置下的標記檔開啟",
  "settings.closedNetworkFlagPath": "標記檔：{path}",
  "settings.closedNetworkDescription": "指向 GitHub 與社群網站的連結、分享到外部站台、使用分析與自動更新皆已關閉。如需修改請聯絡管理員。",
