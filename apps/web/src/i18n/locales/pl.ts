...
export const pl: Dict = {
  ...
  'settings.customProviderHint': 'Zdefiniowane w pliku konfiguracyjnym demona (byok-providers.local.json).',
  'settings.customProviderEmpty': 'Nie znaleziono niestandardowych dostawców. Zdefiniuj jednego w byok-providers.local.json.',
  'settings.customProviderPlaceholder': 'Wybierz dostawcę…',
