...
export const id: Dict = {
  ...
  'settings.customProviderHint': 'Didefinisikan di file konfigurasi daemon (byok-providers.local.json).',
  'settings.customProviderEmpty': 'Tidak ada penyedia khusus. Tentukan satu di byok-providers.local.json.',
  'settings.customProviderPlaceholder': 'Pilih penyedia…',
