...
export const fa: Dict = {
  ...
  'settings.closedNetworkTitle': 'حالت شبکه بسته',
  'settings.closedNetworkOn': 'روشن',
  'settings.closedNetworkSourceEnv': 'با متغیر محیطی OD_CLOSED_NETWORK فعال شده است',
  'settings.closedNetworkSourceFlagFile': 'با یک فایل نشانه در محل پروژه شما فعال شده است',
  'settings.closedNetworkFlagPath': 'فایل نشانه: {path}',
  'settings.closedNetworkDescription': 'پیوندها به گیت‌هاب و شبکه‌های اجتماعی، اشتراک‌گذاری در سایت‌های بیرونی، تحلیل استفاده و به‌روزرسانی خودکار خاموش شده‌اند. برای تغییر با مدیر سیستم تماس بگیرید.',
