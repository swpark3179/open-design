...
export const fa: Dict = {
  ...
  'settings.customProviderHint': 'در فایل پیکربندی دیمن (byok-providers.local.json) تعریف می‌شود.',
  'settings.customProviderEmpty': 'هیچ ارائه‌دهنده سفارشی یافت نشد. یکی را در byok-providers.local.json تعریف کنید.',
  'settings.customProviderPlaceholder': 'یک ارائه‌دهنده انتخاب کنید…',
