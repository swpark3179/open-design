...
export const th: Dict = {
  ...
  'settings.customProviderHint': 'กำหนดในไฟล์การตั้งค่าของ daemon (byok-providers.local.json)',
  'settings.customProviderEmpty': 'ไม่พบผู้ให้บริการที่กำหนดเอง กำหนดได้ใน byok-providers.local.json',
  'settings.customProviderPlaceholder': 'เลือกผู้ให้บริการ…',
