...
export const ko: Dict = {
  ...
  'settings.customProviderHint': '데몬 설정 파일(byok-providers.local.json)에서 정의합니다.',
  'settings.customProviderEmpty': '사용자 지정 제공자가 없습니다. byok-providers.local.json에서 정의하세요.',
  'settings.customProviderPlaceholder': '제공자 선택…',
